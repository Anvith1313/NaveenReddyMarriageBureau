      ...
      <div className={s.homeBelow}>
        ...
        <div className={s.featSnapSlide}>
          <div className={s.statsBar}>
            <div className={`${s.statItem} reveal reveal-d1`}><div className={s.statN}><span ref={refMembers}>10K+</span></div><div className={s.statL}>Registered Members</div></div>
            <div className={`${s.statItem} reveal reveal-d2`}><div className={s.statN}><span ref={refMatches}>4,500+</span></div><div className={s.statL}>Successful Matches</div></div>
            <div className={`${s.statItem} reveal reveal-d3`}><div className={s.statN}><span ref={refYears}>25+</span></div><div className={s.statL}>Years of Trust</div></div>
            <div className={`${s.statItem} reveal reveal-d4`}><div className={s.statN}>100%</div><div className={s.statL}>Verified Profiles</div></div>
            <div className={`${s.statItem} reveal reveal-d5`}><div className={s.statN}><span ref={refDistr}>50+</span></div><div className={s.statL}>Districts Covered</div></div>
          </div>
          ...
          <section className={s.featSection}>
            ...
            <div className={s.featGrid}>
              <div className={`${s.featOuter} reveal reveal-d1`}><div className={s.featCard}>
              ...
              <div className={`${s.featOuter} reveal reveal-d2`}><div className={s.featCard}>
                <div className={s.featIcon}>
              ...
              <div className={`${s.featOuter} reveal reveal-d3`}><div className={s.featCard}>
                <div className={s.featIcon}>
              ...
              <div className={`${s.featOuter} reveal reveal-d4`}><div className={s.featCard}>
                <div className={s.featIcon}>
              ...
              <div className={`${s.featOuter} reveal reveal-d5`}><div className={s.featCard}>
                <div className={s.featIcon}>
              ...
              <div className={`${s.featOuter} reveal reveal-d6`}><div className={s.featCard}>
                <div className={s.featIcon}>
        ...
        <section className={s.processSection}>
          ...
          <div className={s.processGrid}>
            <div className={`${s.processOuter} reveal reveal-d1`}><div className={s.processCard}>
            ...
            <div className={`${s.processOuter} reveal reveal-d2`}><div className={s.processCard}>
            ...
            <div className={`${s.processOuter} reveal reveal-d3`}><div className={s.processCard}>
            ...
            <div className={`${s.processOuter} reveal reveal-d4`}><div className={s.processCard}>
        ...
        <div className={s.storiesCtaSlide}>
          <div>
            ...
            <div className={s.storiesGrid}>
              <div className={`${s.storyCard} reveal reveal-d1`}>
              ...
              <div className={`${s.storyCard} reveal reveal-d2`}>
              ...
              <div className={`${s.storyCard} reveal reveal-d3`}>
